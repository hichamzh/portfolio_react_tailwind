...
const Main = () => {
    return (
        ...
        <div className=' w-full mx-auto h-[80%] flex flex-col-reverse items-center justify-center lg:flex-row lg:w-9/12 lg:h-[70%]'>
            ...
            <p className='text-balance text-sm'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Reprehenderit, inventor Lorem ipsum dolor sit, amet consectetur adipisicing elit. Animi, quas.</p>
